    ...
    <section className="bg-gradient-to-br from-cream-50 to-white pt-4 pb-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16 px-4 md:px-8">
        ...
        <div className="flex-1 flex items-center justify-center w-full max-w-md mb-8 md:mb-0">
          <MacbookProMockup>
            <div style={{ width: '100%', height: '100%', background: '#181A1B', borderRadius: 18, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 8, overflow: 'hidden' }}>
              <div style={{ width: '100%', height: '100%', transform: 'scale(0.5)', transformOrigin: 'center center' }}>
                <IpadFormApp />
              </div>
            </div>
          </MacbookProMockup>
