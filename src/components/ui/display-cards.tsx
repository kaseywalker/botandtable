...
function DisplayCard({
  ...
  title = "Featured",
  description = "Collecting Google reviews automatically...",
  date = "Just now",
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[26rem] max-w-md select-none flex-col justify-between rounded-xl border border-muted bg-white px-6 py-5 transition-all duration-700 shadow-sm [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}
    >
      <div>
